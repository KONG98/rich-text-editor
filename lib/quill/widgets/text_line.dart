...
class TextLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("textspan: " + textSpan.toString());
  ...
  TextSpan _buildTextSpan(BuildContext context) {
    ...
    if (line.style.containsKey(Attribute.placeholder.key)) {
      ...
      print(TextSpan(children: children, style: textStyle).toString());
    ...
    print("textspan(children,style): " +
        TextSpan(children: children, style: textStyle).toString());
    print('children next:' +
        children.toString() +
        "    " +
        children.runtimeType.toString());

    if (block == Attribute.markdownBlock) {
      print('markdown abcdefgllllllll');
...
/**
  ...
  TextSpan _getTextSpanFromNode(DefaultStyles defaultStyles, Node node) {
    ...
    <String, TextStyle?>{
      ...
      //Attribute.font.key: defaultStyles.font1
    }.forEach((k, s) {
    ...
    if (font != null && font.value != null) {
      print("传递font value " + font.value);
      print("传递的type  " + font.value.runtimeType.toString());
      switch (font.value) {
        case 'style1':
          print('style1');
          print(defaultStyles.font1.toString());
          print(defaultStyles.font1.runtimeType.toString());
          res = res.merge(defaultStyles.font1);
          break;
        case 'style2':
          print('style1');
          res = res.merge(defaultStyles.font2);
          break;
        case 'style3':
          print('style3');
          res = res.merge(defaultStyles.font3);
          break;
        default:
          print('default');
          res = res.merge(TextStyle(fontFamily: 'B'));
      }
    }
...
class RenderEditableTextLine extends RenderEditableBox {
  ...
  void setCursorCont(CursorCont c) {
    ...
    cursorCont = c;
    markNeedsLayout(); //把 element 标记为dirty，重新绘制
  }
  ...
  TextSelectionPoint _getEndpointForSelection(
    ...
    debugPrint("boxes!" + boxes.toString());
