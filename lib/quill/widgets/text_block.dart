...
class EditableTextBlock extends StatelessWidget {
  ...
  BoxDecoration? _getDecorationForBlock(
    ...
    if (attrs.containsKey(Attribute.markdownBlock.key)) {
      return defaultStyles!.markdown!.decoration;
    }
    return null;
  }
  ...
  Tuple2 _getSpacingForLine(
    ...
    if (attrs.containsKey(Attribute.header.key)) {
      ...
      } else if (attrs.containsKey(Attribute.markdownBlock.key)) {
        lineSpacing = defaultStyles!.markdown!.lineSpacing;
      }
