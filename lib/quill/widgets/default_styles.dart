...
class DefaultStyles {
  ...
  final DefaultTextBlockStyle? markdown;
  ...
  static DefaultStyles getInstance(BuildContext context) {
    ...
    return DefaultStyles(
        ...
        markdown: DefaultTextBlockStyle(
            TextStyle(
              color: Colors.blue.shade900.withOpacity(0.9),
              fontFamily: fontFamily,
              fontSize: 13,
        ...
        font1: const TextStyle(fontFamily: 'A'),
        font2: const TextStyle(fontFamily: 'B'),
        font3: const TextStyle(fontFamily: 'C'));
  }
